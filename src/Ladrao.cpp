...
Ladrao::Ladrao(std::string nome, int forca, int agilidade, int inteligencia):
    ...
    _nome_classe = "Ladrao";_habilidade_1 = "Drenar Energia";
...
std::string Ladrao::get_habilidade(int habilidade_escolhida) {
...
void Ladrao::usa_habilidade(int habilidade_escolhida, std::vector<Personagem*> grupo_aliado, std::vector<Personagem*> grupo_inimigo) {
    switch (habilidade_escolhida)
    {
        case 1: 
